  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ScreenshotCustomWidget(image: movieDetails.largeScreenshotImage1 ?? ''),
        SizedBox(height: height * .02),
        ScreenshotCustomWidget(image: movieDetails.largeScreenshotImage2 ?? ''),
        SizedBox(height: height * .02),
        ScreenshotCustomWidget(image: movieDetails.largeScreenshotImage3 ?? ''),
